...
@SourceType(value = "BitbucketARP", label = "Bitbucket",uiConfig = "bitbucket-layout.json")
public class BitbucketConf extends AbstractArpConf<BitbucketConf> {
  private static final String ARP_FILENAME = "arp/implementation/bitbucket-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.bitbucket.BitbucketDriver";
